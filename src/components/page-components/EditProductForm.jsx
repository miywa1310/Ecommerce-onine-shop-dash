            ...
            <Formik
                ...
                onSubmit={(values, actions) => {
                    ...
                    try {
                        ...
                        dispatch(updateProduct({ urlProduct, id: item.id, updateData: newValues }))
                ...
                <Form className='flex flex-col gap-[5px]'>
                    ...
                    <div className="flex flex-col ">
                        <label htmlFor="images">
                            ...
                            <div ref={imageCont} className="flex mb-[5px] justify-start gap-1 items-center flex-wrap">
                            </div>
                        </label>
                        
                        <div className="relative">
                            <Field name="images" type="url">
                                {(field) => (
                                    <input {...field} ref={ImgInput} className="py-[7px] w-full border-[1px] hover:border-orange-400 rounded-md px-[15px] outline-none " type="url" id="images" placeholder="Enter the images url. Please enter separately" />
                                )}
                            </Field>
